...
import { getPrisonRoom, addSpectator, removeSpectator, heartbeatSpectator } from '@/lib/prison-room-store';

// POST /api/prison-room/[code]/spectator — Join as spectator
...
// PUT /api/prison-room/[code]/spectator — Heartbeat
...
// DELETE /api/prison-room/[code]/spectator — Leave
