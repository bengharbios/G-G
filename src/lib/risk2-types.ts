...
export const SPECIAL_CARD_INFO: Record<string, { emoji: string; label: string; desc: string; color: string; bg: string }> = {
  ...
  double: { emoji: '×2', label: 'ضعف',       desc: 'رصيد الجولة × 2!',                 color: '#f59e0b', bg: 'from-amber-900/40 to-amber-950/60' },
  triple: { emoji: '×3', label: 'ثلاثة أضعاف', desc: 'رصيد الجولة × 3!',             color: '#a855f7', bg: 'from-purple-900/40 to-purple-950/60' },
};
